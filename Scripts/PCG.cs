...
//This script utilises the Cellular Automata algorithms to procedurely generate the content of the level, so that every level feels different.
...
#region Enemies
    ...
    private void Start()
    {
        ...
        //The minimum and maximum width the Dungeon can get randomised
        minWidth = 50;
        maxWidth = 100;
        //Randomise the width and height of the Dungeon
...
#region Portal
    ...
    //Checks if the portal spawns too close to a wall
    ...
    //Method to smooth the walls of the level.
    ...
    IEnumerator LoadWin()
    {
        //Turn off canTakeDamage to make sure that the player can't get hurt when the win loading is in progress
