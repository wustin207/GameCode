...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		if (collision.transform.tag == "Zombie") 
		{
            ...
            {
                zombieScript.TakeDamage(damageAmount);
            }
		}

		if (collision.transform.tag == "Archer")
		{
			ArcherAI archerScript = collision.gameObject.GetComponent<ArcherAI>();
			if (archerScript != null)
			{
				archerScript.TakeDamage(damageAmount);
			}
		}

		if (collision.transform.tag == "Skeleton")
		{
			SkeletonAI skeletonScript = collision.gameObject.GetComponent<SkeletonAI>();
			if (skeletonScript != null)
			{
				skeletonScript.TakeDamage(damageAmount);
			}
		}
